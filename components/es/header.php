    ...
    <div class="header">
      <div class="header__grid">
        ...
        <nav class="header__menu" id="header__mymenu">
          ...
          <a class="header__menu__link active" <?php echo 'href="zerbitzuak.php?language=' . $language . '"'; ?>>SERVICIO</a>
          <a class="header__menu__link active" <?php echo 'href="kontaktua.php?language=' . $language . '"'; ?>>CONTACTO</a>
        </nav>
      </div>
    </div>  
