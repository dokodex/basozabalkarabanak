<section class="section home">
  ...
  <div class="home__grid">
    ...
    <nav class="home__menu">
      <a class="home__menu__link" <?php echo 'href="zerbitzuak.php?language=' . $language . '"'; ?>>SERVICIO</a>
      <a class="home__menu__link" <?php echo 'href="kontaktua.php?language=' . $language . '"'; ?>>CONTACTO</a>
    </nav>
